...
public class CalendarView extends FrameLayout {
    ...
    private static final int UNSCALED_SELECTED_DATE_ARROW_WIDTH = 3;
    ...
    private boolean parseDate(String date, Calendar outDate) {
        try {
            ...
            Log.w(LatrApp.APP_TAG, "Date: " + date + " not in format: " + DATE_FORMAT);
            return false;
        }
    }
    ...
    private void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
        ...
        long currScroll = view.getFirstVisiblePosition() *
    ...
    private class WeeksAdapter extends BaseAdapter implements OnTouchListener {
         ...
         *
         * @param calendar The time to highlight
         */
        public void setSelectedDay(Calendar calendar, boolean send) {
            ...
            if (send) {
                ...
                mListView.sendAccessibilityEvent(AccessibilityEvent.TYPE_VIEW_FOCUSED);
            }
        }
    ...
    private class WeekView extends View {
        ...
        private void drawSelectedDateArrows(Canvas canvas) {
            ...
            Point b = new Point(mSelectedLeft + mSelectedDateArrowWidth,
                    mHeight / 2 + mWeekSeparatorLineWidth);
    ...
    /**
     * Used to save / restore instance state
     */
